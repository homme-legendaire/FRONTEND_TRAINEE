...
// assets
import { Tallymark1, Home, Home2 } from "tabler-icons-react";
...
const Breadcrumbs = ({
  ...
  if (main && main.type === "collapse") {
    CollapseIcon = main.icon ? main.icon : null;
    mainContent = (
      ...
      breadcrumbContent = (
        ...
        >
          ...
          {card === false && divider !== false && (
            <Divider sx={{ borderColor: theme.palette.primary.main, mb: 3 }} />
          )}
        </Card>
      );
    }
